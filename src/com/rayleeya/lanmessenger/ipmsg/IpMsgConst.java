...
public class IpMsgConst {
	public static final String IPMSG_VERSION = "1";		// 版本号
	public static final String IPMSG_BROADCAST_ADDRESS = "255.255.255.255";
	public static final String IPMSG_MULTICAST_ADDRESS = "";
	
	private static final int IPMSG_PORT = 2425;			// 端口号，飞鸽协议默认端口2425
	private static int mPort = IPMSG_PORT;
	...
	public static final String IPMSG_PART_SPLITER = ":";
	public static final String IPMSG_ADITIONAL_SPLITER = ".";
	 ...
	 * This is the point
	 */
	public static final int IPMSG_VOICE_REQ          = 0x00000080;  //语音通话请求
	public static final int IPMSG_VOICE_RES          = 0x00000081;  //语音通话响应
	public static final int IPMSG_VOICE_DATA         = 0x00000082;  //语音通话数据
	
	public static final int IPMSG_VOICE_OPT_OK       = 0x00000100;  //语音通话响应:接收
	public static final int IPMSG_VOICE_OPT_KO       = 0x00000200;  //语音通话响应:拒绝
